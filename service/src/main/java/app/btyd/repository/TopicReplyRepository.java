...
import app.btyd.entity.TopicReplyEntity;
...
public class TopicReplyRepository {
    ...
    public List<TopicReplyEntity> selectTopicReplyList(Integer topicId) {
        var sql = """
        ...
        var rowMapper = new DataClassRowMapper<>(TopicReplyEntity.class);
